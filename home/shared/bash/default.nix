  ...
  config = mkIf cfg.enable {
    programs.bash = {
      ...
      shellAliases = {
        ...
        # Alias nixos;
        nrb = "sudo nixos-rebuild boot --flake ${dotDir} ${nixos-buildopts}";
        nrbwc = "sudo nixos-rebuild boot -p WorkingConfig --flake ${dotDir} ${nixos-buildopts}";
        nrt = "sudo nixos-rebuild test --flake ${dotDir} ${nixos-buildopts}";
