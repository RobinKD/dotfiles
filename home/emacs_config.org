  ...
  (use-package mu4e
    ...
    (setq mu4e-bookmarks
	  '((:name "Unread messages"
		   :query "flag:unread AND NOT maildir:/hotmail/Deleted AND NOT maildir:/orga1-short/Trash AND NOT maildir:/en/Corbeille"
		   :key ?u)
	    (:name "Today's messages"
		   :query "date:today..now AND NOT maildir:/hotmail/Deleted AND NOT maildir:/orga1-short/Trash AND NOT maildir:/orga1-short/Sent AND NOT maildir:/en/Envois AND NOT maildir:/en/Corbeille AND NOT maildir:/hotmail/Sent"
		   :key ?t)
	    (:name "Last 7 days"
		   :query "date:7d..now AND NOT maildir:/hotmail/Deleted AND NOT maildir:/orga1-short/Trash AND NOT maildir:/orga1-short/Sent AND NOT maildir:/en/Envois AND NOT maildir:/en/Corbeille AND NOT maildir:/hotmail/Sent"
		   :key ?w)
  ...
  (setq mu4e-contexts
	(list
	 (make-mu4e-context
	  ...
	  :vars '((user-mail-address . "Username2@orga2.fr")
		  ...
		  (smtpmail-smtp-user . "Username2@orga2.fr")
...
#+begin_src elisp
  (make-mu4e-context
   ...
   :vars '((user-mail-address . "Username2@orga3.fr")
	   (user-full-name . "Name1")
...
#+begin_src elisp
  (make-mu4e-context
   ...
   :vars '((user-mail-address . "Username2@hotmail.fr")
	   (user-full-name . "Name1")
	   ...
	   (smtpmail-smtp-user . "Username2@hotmail.fr")
